...
const SqlGame2 = ({socket} : GamePageProps) => {
  ...
  const handleAlert = async () => {
    ...
    {
      if (input === "Hello App Administrator") 
      {
        alert("Congratulations! You entered the correct flag!");
        socket.emit("updateScore_lev6", {userid:id, score: myscore})
        navigate(`/home/${id}`);
      } else {
  ...
  return (
    ...
    <div className="sql-game-container">
      <h2 className="sql-game-title">SQL Injection Game 2</h2>
      <p className="sql-game-instructions">Play the game in the link below and enter the flag here:</p>
      <br></br><p>(the flag is the text acquired upon successful Login in the game)</p>
        <a className="sql-game-link" href="https://www.codingame.com/playgrounds/154/sql-injection-demo/sql-injection-2">Click here for game</a>
      <br />
      <br />
